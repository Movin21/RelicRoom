...
//   apiKey: "AIzaSyADt_S2q_VqBADBTLunkcafZqDnFP1HA78",
//   authDomain: "relicroom-3d78e.firebaseapp.com",
//   projectId: "relicroom-3d78e",
//   storageBucket: "relicroom-3d78e.appspot.com",
//   messagingSenderId: "1070597884238",
//   appId: "1:1070597884238:web:94b2fcc334b4e1625df61f",
//   measurementId: "G-5WZP5L7WD4"
// };
...
const BidderProfile = () => {
  ...
  const onSubmit = async (values: z.infer<typeof FormSchema>) => {
    ...
    try {
      await axios.patch(
        `http://localhost:3000/bidder/update/${bidder._id}`,
        values
      );
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              ...
              <Link to="#">
                <div className="flex items-center mb-2 gap-16 hover:scale-110 transition duration-300 ease-in-out">
                  <span
                    ...
                    className=" text-secondary font-akshar text-l font-semibold mr-6"
                  >
                    Dashboard
                  </span>
                  <svg
              ...
              <Link to="#">
                <div className="flex items-center mb-2 hover:scale-110 transition duration-300 ease-in-out">
                  <span
                    ...
                    className="text-brownDark font-akshar text-l font-semibold  mr-4 "
                  >
                    My Bids
                  </span>
                  <svg
            ...
            <li className="gap-12 mb-10">
              <Link to="/bidderLogin">
                <div className="flex items-center mb-2 hover:scale-110 transition duration-300 ease-in-out">
                  ...
                  <span
                    onClick={Logout}
                    className="text-red-800 font-akshar text-l font-semibold  ml-2"
                  >
                    Logout
                  </span>
                </div>
        ...
        <CardHeader className="gap-10 mt-11">
          ...
          <div className="flex items-center justify-center ">
            <Card
              className="w-full md:w-96 p-6 mt-0 mb-10 shadow-2xl gap-4"
              style={{ width: "700px" }}
            >
              <CardContent>
                <div>
