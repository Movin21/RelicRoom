   ...
   <div className="flex flex-col md:flex-row items-center justify-center gap-4">
    <Card className="flex flex-col items-center gap-4 px-2 py-5 bg-white shadow-2xl h-96 w-64 mb-52 mt-0 ">
          <ul className="flex flex-col gap-4 mt-4">
              ...
              <li>
                <Link to="#" >
                <div className="flex items-center mb-2 hover:scale-110 transition duration-300 ease-in-out">
                  <span onClick={handleMyBidsClick} className="text-brownDark font-akshar text-l font-semibold  mr-4 " >My Bids</span>
                  <svg onClick={handleMyBidsClick} className="ml-auto" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <CardHeader className='gap-10 mt-11'>
        ...
        <Card className="w-full md:w-96 p-6 mt-0 mb-10 shadow-2xl gap-4" style={{ width: '700px' }}>
            <CardContent>
            <div><input type="file" onChange={handleImageEdit}/> 
            ...
            <Form {...form} >
                ...
                className="max-w-xl w-full flex flex-col gap-4">
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle className="font-akshar text-2xl text-brownMedium">
                              This will erase your data from our platform permanently. Do you want to continue ?
                            </AlertDialogTitle>
                          </AlertDialogHeader>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction className='bg-red-700 hover:bg-red-500'>
                              <Button onClick={onDelete} className="font-akshar w-full bg-red-700 hover:bg-red-500">
                                Continue </Button>
                            </AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
                    ...
                    <div> 
                    <Button className="hover:scale-110 hover:shadow-xl transition duration-300 font-akshar w-40 text-white bg-primary hover:bg-secondary ease-in-out hover:text-white tw-50 mt-4" type="submit">
                      Save Changes</Button>
                      </div>
                    </div>
