    ...
    try {
      ...
      if (filterOption === "Ongoing") {
        response = await axios.get(
          `http://localhost:3000/auctioneer/getOngoingAuctions/${auctioneer._id}`
        );
      } else if (filterOption === "Expired") {
        response = await axios.get(
          `http://localhost:3000/auctioneer/getExpiredAuctions/${auctioneer._id}`
        );
      } else {
        response = await axios.get(
          `http://localhost:3000/auctioneer/getAllAuctions/${auctioneer._id}`
        );
      }
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-8 w-32 gap-1 font-akshar"
              >
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel className="font-akshar">
                Filter by
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuCheckboxItem
      ...
      <div className="flex flex-1">
            ...
            <li>
              <Link to="#">
                <div className="flex items-center mb-2">
                  ...
                  <span className=" text-secondary font-akshar text-xl font-semibold  ml-2">
                    {" "}
              ...
              <Link to="/auctioneerProfile">
                <div className="flex items-center mb-2">
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="font-bold text-brownDark"
                  >
                    <path
        ...
        <div className="ml-4  sm:mt-0 flex-1">
          <Dialog>
            <Card>
              <CardHeader>
                <CardTitle className="font-akshar text-secondary text-4xl ">
                  My Auctions
                </CardTitle>
              </CardHeader>
              <CardContent>
...
//                       <TableRow key={index}>
//                         <TableCell className="hidden sm:table-cell font-akshar">
//                           {bid.auctioneer.companyName((image, index) => (
//                             <img
//                               key={index}
//                               src={image}
//                               alt={`Auction Image ${index}`}
